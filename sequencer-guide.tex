...
\end{figure}
 ...
 Let  
    ...
    \begin{verbatim}
  {
    ...
    Actually, the function that we are looking for, it is pretty much identical to that shown in Figure \ref{seqtime2songtime}. For our toy example, this function will look like
